.. -*- mode: rst -*-
==========================================
 Keyboards for the Eastern Canadian Inuktitut language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Eastern Canadian Inuktitut language. The data and implementations
...
The Eastern Canadian Inuktitut keyboard sources can be acquired using the `Giella SVN
