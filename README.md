...
<tr class="odd">
<td><blockquote>
<p>Keyboards for the Eastern Canadian Inuktitut language</p>
</blockquote></td>
</tr>
</tbody>
</table>
...
developing keyboards for the Eastern Canadian Inuktitut language. The
data and implementations are licenced under \_\_LICENCE\_\_, and the
licence is also detailed in the LICENCE file of this directory. The
...
-   <http://giellatekno.uit.no/ikedoc/index.html>
-   <https://giellalt.uit.no/tools/docu-ike-manual.html>
...
In order to compile and use Eastern Canadian Inuktitut keyboards you
need:
...
The Eastern Canadian Inuktitut keyboard sources can be acquired using
the [Giella SVN
