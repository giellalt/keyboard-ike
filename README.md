# Keyboards for Eastern Canadian Inuktitut
...
keyboards for the Eastern Canadian Inuktitut language. The code
...
The Eastern Canadian Inuktitut keyboard sources can be acquired using the Fork or Code
